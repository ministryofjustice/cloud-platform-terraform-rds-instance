...
| <a name="input_performance_insights_enabled"></a> [performance\_insights\_enabled](#input\_performance\_insights\_enabled) | Enable performance insights for RDS? This is disabled by default, but can be enabled by a user if needed. It is highly recommended that a user disables it after they have obtained the needed insights. | `bool` | `false` | no |
