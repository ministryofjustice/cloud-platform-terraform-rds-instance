...
variable "db_password_spin" {
  description = "The password of the database to be used on the instance (if empty, it will be the generated by first set of random identifier. If "switch_to_succession" , it will be generated by second set of random identifier)"
  default     = ""
  type        = string
}
